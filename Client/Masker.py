...
class Masker:
    ...
    def __init__(self, DH_params: tuple[int], secret_min_limit: int = 0, secret_max_limit: int = 10000000):
        self.g, self.q = DH_params
    ...
    def get_ss(self, num_bytes: int = 8) -> int:
        return Helper.PRNG(self.ss, num_bytes)
    
    def get_ps(self, num_bytes: int = 8) -> int:
